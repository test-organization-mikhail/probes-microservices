...
public class AvgReducerTest {
    ...
    void probeNoValuesTest() {
        ...
        when(listProbeRepo
                .save(new ListProbeValues(PROBE_ID_NO_VALUES)))
                .thenAnswer(new Answer<ListProbeValues>() {
                    @Override
                    public ListProbeValues answer(InvocationOnMock invocationOnMock) throws Throwable {
                        redisMap.put(PROBE_ID_NO_VALUES, invocationOnMock.getArgument(0));
    ...
    void probeNoAvgTest() {
        ...
        when(listProbeRepo
                .save(new ListProbeValues(PROBE_ID_NO_AVG)))
                .thenAnswer(new Answer<ListProbeValues>() {
                    @Override
                    public ListProbeValues answer(InvocationOnMock invocationOnMock) throws Throwable {
                        redisMap.put(PROBE_ID_NO_AVG, invocationOnMock.getArgument(0));
                        return invocationOnMock.getArgument(0);
                    }
                });
        producer.send(new GenericMessage<Probe>(probeNoValues), consumerBindingName);
    ...
    void probeAvgTest() throws IOException {
        ...
        when(listProbeRepo
                .save(new ListProbeValues(PROBE_ID_AVG)))
                .thenAnswer(new Answer<ListProbeValues>() {
                    @Override
                    public ListProbeValues answer(InvocationOnMock invocationOnMock) throws Throwable {
                        redisMap.put(PROBE_ID_AVG, invocationOnMock.getArgument(0));
                        return invocationOnMock.getArgument(0);
                    }
                });
        producer.send(new GenericMessage<Probe>(probeNoValues), consumerBindingName);
